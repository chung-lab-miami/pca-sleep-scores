...
# smoke status
mesa_df$smoke <- factor(NA, levels = c("Never", "Former", "Current", "Do not know"))
mesa_df$smoke[mesa_df$smkstat5 == "Never smoked"] <- "Never"
mesa_df$smoke[mesa_df$smkstat5 == "Former smoker quit more than 1 year ago" |
                mesa_df$smkstat5 == "Former smoker quit less than 1 year ago"] <- "Former"
mesa_df$smoke[mesa_df$smkstat5 == "Current smoker"] <- "Current"
mesa_df$smoke[mesa_df$smkstat5 == "Do not know"] <- "Do not know"

table(mesa_df$smoke, mesa_df$smkstat5)
# End script
